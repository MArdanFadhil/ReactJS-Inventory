                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            {/* ternary untuk mengecek apakah halaman diakses dengan mengirim params pada URL */}
                            {
                                errorMessage ? (
                                    <div class="bg-red-100 border-t border-b border-red-500 text-red-700 px-4 py-3" role="alert">
                                        <p class="font-bold">Gagal dalam memproses halaman</p>
                            ...
                            {/* ternary untuk mengecek apakah state error memiliki data, jika iya munculkan datanya dengan looping */}
                            {
                                Object.keys(error).length > 0? (
                                    <div>
                                        <div class="bg-red-500 text-white font-bold rounded-t px-4 py-2"> Gagal!
                                        </div>
                            ...
                            <form class="space-y-4 md:space-y-6" action="#">
                                <div>
                                    ...
                                    <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@gmail.com" required="" onChange={e => setValues({...values, email: e.target.value})} />
                                </div>
                                <div>
